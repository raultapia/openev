/*!
\file camera.hpp
\brief Camera device driver. This module used libcaer library to configure devices and get data. For more information, please refer <a href="https://gitlab.com/inivation/dv/libcaer">here</a>.
\author Raul Tapia
*/
