...
public:
  ...
  */
  inline void setValues(const Value &positive, const Value &negative, const Value &reset) {
    values_ = {positive, negative, reset};
  }
...
using EventImage3 = EventImage3b;            /*!< Alias for EventImage_ using uchar */
...
using EventHistogram3 = EventHistogram3b;            /*!< Alias for EventHistogram_ using uchar */
...
using TimeSurface3 = TimeSurface3b;            /*!< Alias for TimeSurface_ using uchar */
...
using PointCloud1 = PointCloud1d;
using PointCloud3 = PointCloud3d;
...
using PointCloud1 = PointCloud1d;            /*!< Alias for PointCloud_ using double */
using PointCloud3 = PointCloud3d;            /*!< Alias for PointCloud_ using cv::Vec3d */
using PointCloud = PointCloud1;              /*!< Alias for PointCloud_ using double */

// TODO: Add exp decay to timesurfaces
// TODO: Add option for ignoring polarity
